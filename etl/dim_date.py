...
def load_dim_date(files: list[str] | None = None):
    print("=== Dim_Date ===")
    

    # Wczytaj unikalne daty i godziny z plików BTS
    print("Wczytuję daty z plików BTS...")
    all_data = []
